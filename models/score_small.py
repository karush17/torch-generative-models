...
class ScoreConvNet(nn.Module):
    def __init__(self, args, state_shape, action_dims):
        ...
        self.conv1 = nn.Conv2d(self.n_channels, 16, kernel_size=4, stride=2, padding=1)
        ...
        self.elu3 = nn.ELU()
        self.conv4 = nn.ConvTranspose2d(16, self.n_channels, kernel_size=4, stride=2, padding=1)
        self.elu4 = nn.ELU()
